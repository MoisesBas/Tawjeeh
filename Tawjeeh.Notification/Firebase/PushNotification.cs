...
using Tawjeeh.Notification.Helper;
    ...
    public class PushNotification : IPushNotification
    {
        ...
        private bool SendNotification(PushNotificationLogs fcmdevices)
        {
            ...
            try
            {
                ...
                tRequest.Headers.Add(string.Format("Authorization: key={0}", Utilities.AppId));
                tRequest.Headers.Add(string.Format("Sender: id={0}", Utilities.SenderId));
