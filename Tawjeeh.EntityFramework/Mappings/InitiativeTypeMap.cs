...
{
   public class InitiativeTypeMap: EntityTypeConfiguration<InitiativeType>
    {
        public InitiativeTypeMap()
        {
            HasKey(a => a.Id);
            Property(a => a.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            Property(a => a.Description).HasColumnType("nvarchar").HasMaxLength(150);
