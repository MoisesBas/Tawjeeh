...
{
    public class EmiratesMap : EntityTypeConfiguration<Emirates>
    {
        public EmiratesMap()
        {
            HasKey(a => a.Id);
            Property(a => a.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            Property(a => a.Name).HasColumnType("nvarchar").IsRequired().HasMaxLength(100);
            ...
            HasMany(a => a.Centers).WithOptional(a => a.Emirates).HasForeignKey(a => a.EmiratesId).WillCascadeOnDelete(false);
            ToTable("tblEmirates");
        }
    }
}
