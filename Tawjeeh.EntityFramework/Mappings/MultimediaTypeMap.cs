...
{
    public class MultimediaTypeMap: EntityTypeConfiguration<MultimediaType>
    {
        public MultimediaTypeMap()
        {
            HasKey(a => a.Id);
            Property(a => a.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            Property(a => a.Name).HasColumnType("nvarchar").IsRequired().HasMaxLength(150);
            Property(a => a.Description).HasColumnType("nvarchar").IsOptional();
